...
@interface ___VARIABLE_classPrefix:identifier___PersistenceProxy ()
...
+ (___VARIABLE_classPrefix:identifier___PersistenceProxy *)sharedProxy
{
	...
	dispatch_once(&onceToken, ^{
		_sharedProxy = [[___VARIABLE_classPrefix:identifier___PersistenceProxy alloc] initWithStoreName:@"___PACKAGENAMEASIDENTIFIER___" nestContexts:YES resetThreshold:0];
	});
